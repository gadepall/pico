...
\title{
%	\logo{
पीको द्वारा आर्म-जीसीसी क्रमादेश से परिचय
%	}
}
...
\begin{abstract}
इस लेख में  पीको  के द्वारा सी-क्रमादेशन  से छात्रों का परिचय कराया जाएगा।
...
\item  पीको  के यूएसबी पत्तन के समक्ष   एक गण्ड (BOOTSEL) उपस्थित है।  इसे दबाते हुए  पीको एवं रास्पबेरी पै  को यूएसबी रज्जु से योजित करें।
...
mkdir build #केवल एक बार 
cd build
cmake ..
make -j4
scp  main.uf2 pi@192.168.0.114:
\end{lstlisting}
ऊपर main.uf2  सञ्चिका प्रेषण पूर्व रास्पबेरी पै का उचित अनिकेत दें। 
\item अब रास्पबेरी पै  में प्रवेश कर निम्न  आदेश का चालयन करें
\begin{lstlisting}
sudo mkdir /mnt/pico #केवल एक बार 
sudo fdisk -l
...
\item पीको को RUN कुश को GND से मेलन करें। तत्पश्चात BOOTSEL को दबाते हुए RUN-GND तंतु को GND
से निकालें। दीप निरुज्जवल हो जाएगा। अब पीको का पुनः प्रस्फुरण किया जा सकता है। 
\end{enumerate}
%
\section{अतिकाल}
...
\end{lstlisting}
%
इससे हम ज्ञात कर सकते हैं की पीको परिपथफलक के दीप का शमीलनकाल 500 ms = 0.5 s।  
...
\item इदान  आर्म-जीसीसी  के द्वारा दीप को स्थायी रूप में ज्वलित करें।
\\
\solution निम्न क्रमादेश का चालयन करें।
\begin{lstlisting}
codes/setup/onoff/main.c
\end{lstlisting}
\item एक अन्य कुश को निर्गत रूप देकर किसी बाह्य दीप को प्रकाशोर्जित करें। 
\\
\solution  निम्न सारणी के अनुसार  दीप से  मेलन करें। प्रतिरोधक का उपयोग न भूलें। तत्पश्चात निम्न क्रमादेश का चालयन करें। 
\begin{lstlisting}
...
\begin{tabular}{|l|l|l|}
\hline
प्रकार & पीको कुश  &  गम्य \\ \hline
निर्गत &  3V3 &  LED\\ \hline
निर्गत  & GP2  &  LED\\ \hline

\end{tabular}
\end{table}

\item  निम्न क्रमादेश को चलायित कर GND से एक तंतु को GP0 से स्पर्शित करें। दीप प्रकाशहीन रहेगा। इस क्रिया की पुरावृत्ति पर  दीप श्मीलित होता रहेगा।  
\begin{lstlisting}
