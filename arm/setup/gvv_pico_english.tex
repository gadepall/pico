...
\begin{abstract}
An introduction to embedded-C programming is provided using the pico-sdk.
%इस लेख में  pico   के द्वारा सी-क्रमादेशन  से छात्रों का परिचय कराया जाएगा।
...
Keep this button pressed while connecting the 
RPi to the Pico through the USB cable.
%pico   के यूएसबी पत्तन के समक्ष   एक गण्ड  उपस्थित है।  इसे दबाते हुए  pico  एवं रास्पबेरी पै  को यूएसबी रज्जु से योजित करें।
%\item  pico   के यूएसबी पत्तन के समक्ष   एक गण्ड  उपस्थित है।  इसे दबाते हुए  pico  एवं रास्पबेरी पै  को यूएसबी रज्जु से योजित करें।
\item Login to termux-ubuntu and execute the following commands.
%अब एंड्राइड यंत्र में टेरमक्स-उबुन्टु में प्रवेश करें ऐवं निम्न आदेशों का चालयन करें।
\begin{lstlisting}
cd ˜
...
cmake ..
make -j4
scp  blink.uf2 pi@192.168.0.114:
\end{lstlisting}
Suitably modify the above ip address before sending blink.uf2 .
...
%तत्पश्चात यूएसबी पत्तन के दक्षिण दिशा में  प्रकाश उत्सर्जक पीत रंग  में श्मीलित होगा। 
%\item  तत्पश्चात यूएसबी पत्तन के दक्षिण दिशा में  प्रकाश उत्सर्जक पीत रंग  में श्मीलित होगा। 
\end{enumerate}
%
\section{Delay}
%\section{अतिकाल}
...
%इससे हम ज्ञात कर सकते हैं की pico  परिपथफलक के दीप का शमीलनकाल 500 ms = 0.5 s।  
...
%इदान  आर्म-जीसीसी  के द्वारा दीप को स्थायी रूप में ज्वलित करें।
\\
\solution Execute the following code.
%निम्न क्रमादेश का चालयन करें।
\begin{lstlisting}
codes/setup/onoff/main.c
\end{lstlisting}
\item Use GP0 as an output pin and drive an LED.
%एक अन्य pin को Output रूप देकर किसी बाह्य दीप को प्रकाशोर्जित करें। 
\\
\solution  Connect the LED to pico as per Table \ref{table:setup_led} and Fig. \ref{fig:pin_sheet}

%निम्न सारणी के अनुसार  दीप से  मेलन करें। प्रतिरोधक का उपयोग न भूलें। तत्पश्चात निम्न क्रमादेश का चालयन करें। 
\begin{lstlisting}
...
Output  & GP0  &  LED\\ \hline
%प्रकार & pico  pin  &  गम्य \\ \hline
%Output &  3V3 &  LED\\ \hline
%Output  & GP0  &  LED\\ \hline
\end{tabular}
...
\item  Execute the following code.  Connect a wire to GND and touch GP0 on the pico.  The onboard LED will turn off.
Repeat this exercise to blink the LED manually.
%निम्न क्रमादेश को चलायित कर GND से एक तंतु को GP0 से स्पर्शित करें। दीप प्रकाशहीन रहेगा। इस क्रिया की पुरावृत्ति पर  दीप श्मीलित होता रहेगा।  
\begin{lstlisting}
